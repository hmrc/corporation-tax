...
case class RdsAccountingPeriod(accountingPeriods: List[RdsAccountingPeriodsRowResponse])

object RdsAccountingPeriod {
  implicit val format: OFormat[RdsAccountingPeriod] = Json.format[RdsAccountingPeriod]
}
...
object RdsAccountingPeriodsRowResponse {
  implicit val format: OFormat[RdsAccountingPeriodsRowResponse] = Json.format[RdsAccountingPeriodsRowResponse]
}
