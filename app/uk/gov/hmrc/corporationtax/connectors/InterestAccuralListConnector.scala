...
class InterestAccuralListConnector @Inject()(http: HttpClientV2, config: ServicesConfig)(implicit ec: ExecutionContext)
  ...
  def getInterestAccuralList(taxRef: Long, accPeriod: Long, interestType: String)(implicit hc: HeaderCarrier): Future[InterestAccuralList] = {
    ...
    http
      ...
      .recover { case e: Throwable =>
        logger.error(s"[InterestAccuralListConnector][getInterestAccuralList]: $taxRef :: $accPeriod :: $interestType - ${e.getMessage}")
